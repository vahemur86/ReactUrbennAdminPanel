          ...
          <div className="col-lg-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <Slider {...settings1}>
                  <div>
                    <img src="https://via.placeholder.com/499x312" alt="carousel item" className="img-fluid"/>
                  </div>
                  <div>
                    <img src="https://via.placeholder.com/499x312" alt="carousel item" className="img-fluid"/>
                  </div>
          ...
          <div className="col-lg-12">
            <div className="card">
              <div className="card-body">
                ...
                <Slider {...settings2}>
                  <div>
                    <img src="https://via.placeholder.com/269x168" alt="carousel item" className="img-fluid"/>
                  </div>
                  <div>
                    <img src="https://via.placeholder.com/269x168" alt="carousel item" className="img-fluid"/>
                  </div>
