              ...
              <div className="card-body">
                ...
                <div className="row">
                  <div className="col-md-6">
                    <address>
                      <p className="font-weight-bold">Justdo imc</p>
                      <p> 695 lsom Ave, </p>
                      <p> Suite 00 </p>
          ...
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <div className="media">
                  <i className="ti-world icon-md text-info d-flex align-self-start mr-3"></i>
          ...
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <div className="media">
                  <i className="ti-world icon-md text-info d-flex align-self-center mr-3"></i>
                  <div className="media-body">
                    <p className="card-text">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque.</p>
                  </div>
                </div>
          ...
          <div className="col-md-4 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <div className="media">
                  <i className="ti-world icon-md text-info d-flex align-self-end mr-3"></i>
                  <div className="media-body">
                    <p className="card-text">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque.</p>
                  </div>
                </div>
