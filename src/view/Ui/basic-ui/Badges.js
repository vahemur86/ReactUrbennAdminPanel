                  ...
                  <table className="table mb-0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className="pr-0 text-right"><div className="badge badge-pill badge-danger"><i className="ti-email mr-2"></i>12</div></td>
                      </tr>
                      <tr>
                        <td className="pl-0">Icon With Text</td>
                        <td className="pr-0 text-right"><div className="badge badge-pill badge-success">12<i className="ti-email ml-2"></i></div></td>
                      </tr>
                      <tr>
                        <td className="pl-0">Icon Badge</td>
