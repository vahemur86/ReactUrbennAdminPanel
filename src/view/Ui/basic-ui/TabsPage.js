              ...
              <div className="card-body">
                ...
                <Tabs defaultActiveKey="home" id="uncontrolled-tab-example">
                  <Tab eventKey="home" title="Home" className="test-tab">
                    <div className="media">
                      <img className="mr-3 w-25 rounded" src="https://via.placeholder.com/116x116" alt="sample"/>
                  ...
                  <h4>Contact us </h4>
                    ...
                    <p>
                      <i className="ti-headphone-alt text-info mr-2"></i>
                      +123456789
                    </p>
                    <p>
                      <i className="ti-email text-success mr-2"></i>
                        ...
                        <Nav variant="pills" className="flex-column">
                          ...
                          <Nav.Item>
                            <Nav.Link eventKey="third" className="d-flex align-items-center">
                              <i className="ti-email text-success pr-2"></i>
                              Mail
                            </Nav.Link>
                          </Nav.Item>
                        </Nav>
                        ...
                        <Tab.Content>
                          <Tab.Pane eventKey="first">
                            <div className="text-center">
                              <img className="mr-3 w-25 mb-4" src="https://via.placeholder.com/83x83" alt="sample"/>
                            </div>
                            <p>
                          ...
                          <Tab.Pane eventKey="second">
                            <div className="text-center">
                              <img className="mb-3 w-25 rounded" src="https://via.placeholder.com/83x83" alt="sample"/>
                        ...
                        <Tab.Content>
                          <Tab.Pane eventKey="first">
                            ...
                            <div className="d-flex mt-4">
                              <img src="https://via.placeholder.com/123x123" className="w-25 h-100 rounded" alt="sample" />
                              <img src="https://via.placeholder.com/123x123" className="w-25 h-100 ml-2 rounded" alt="sample" />
                            </div>
                          ...
                          <Tab.Pane eventKey="second">
                            <div className="media">
                              <img className="align-self-center mr-3 w-25 rounded" src="https://via.placeholder.com/123x123" alt="sample"/>
                              <div className="media-body">
                          ...
                          <Tab.Pane eventKey="third">
                            <div className="media">
                              ...
                              <img className="ml-3 w-25" src="https://via.placeholder.com/123x123" alt="sample"/>
                            </div>
                          </Tab.Pane>
                        </Tab.Content>
                      </Col>
                        ...
                        <Tab.Content>
                          <Tab.Pane eventKey="first">
                            <div className="d-flex mb-4">
                              <img src="https://via.placeholder.com/260x260" className="w-25 h-100 rounded" alt="sample"/>
                              <img src="https://via.placeholder.com/260x260" className="w-25 h-100 ml-4 rounded" alt="sample"/>
                              <img src="https://via.placeholder.com/260x260" className="w-25 h-100 ml-4 rounded" alt="sample"/>
                            </div>
                          ...
                          <Tab.Pane eventKey="fourth">
                            <div className="media">
                              <img className="mr-3 w-25 rounded" src="https://via.placeholder.com/260x260" alt="sample"/>
                              <div className="media-body">
