                            ...
                            <div className="card-body">
                                ...
                                <Dropzone accept={'image/*'} onDrop={this.onDrop} >
                                    {({getRootProps, getInputProps}) => (
                                        <section>
                                        <div {...getRootProps()} style={{minHeight: '200px', border: '1px solid #424351'}}>
                                            <input {...getInputProps()} />
...
function DropzoneDemoTwo(props) {
    ...
    return (
      <div>
        <div {...getRootProps({className: 'dropzone'})} style={{minHeight: '200px', border: '1px solid #424351', padding: '15px', display: 'flex', flexDirection: 'column'}}>
          <input {...getInputProps()} />
                    ...
                    { this.state.users.map((user, index) => {
                        return (
                            <div key={user.id} className="d-flex mb-2">
                                ...
                                {(index > 0) ? <button className="btn btn-danger btn-sm icon-btn ml-2" onClick={()=>this.deleteUser(index)}><i className="ti-trash"></i></button> : null }
                            </div>
                        )
                    })}
                </div>
