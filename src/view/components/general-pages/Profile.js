                ...
                <div className="row">
                  <div className="col-lg-4">
                    <div className="border-bottom text-center pb-4">
                      <img src="https://via.placeholder.com/92x92" alt="profile" className="img-lg rounded-circle mb-3"/>
                      <div className="mb-3">
                        <h3>David Grey. H</h3>
                  ...
                  <div className="col-lg-8">
                    <div className="d-block d-md-flex justify-content-between mt-4 mt-md-0">
                      <div className="text-center mt-4 mt-md-0">
                        ...
                        <button className="btn btn-primary ml-2">Request</button>
                      </div>
                    </div>
                    ...
                    <div className="profile-feed">
                      <div className="d-flex align-items-start profile-feed-item">
                        ...
                        <div className="ml-4">
                          <h6>
                            Mason Beck
                            <small className="ml-4 text-muted"><i className="ti-time mr-1"></i>10 hours</small>
                          </h6>
                          <p>
                          ...
                          <p className="small text-muted mt-2 mb-0">
                            <span>
                              <i className="ti-star mr-1"></i>4
                            </span>
                            <span className="ml-2">
                              <i className="ti-comment mr-1"></i>11
                            </span>
                            <span className="ml-2">
                      ...
                      <div className="d-flex align-items-start profile-feed-item">
                        ...
                        <div className="pl-4">
                          ...
                          <img src="https://via.placeholder.com/640x384" alt="sample" className="rounded mw-100"/>                            
                          <p className="small text-muted mt-2 mb-0">
                            <span>
                              <i className="ti-star mr-1"></i>4
                            </span>
