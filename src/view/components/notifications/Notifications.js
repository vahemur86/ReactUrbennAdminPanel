                            ...
                            <div className="card-body">
                                ...
                                <Alert variant="secondary">
                                    ...
                                    <p className="mb-0 p-3">
                                        <button className="btn btn-secondary mb-2">Ok</button><button className="btn btn-inverse-secondary mb-2 ml-2">Cancel</button>
                                    </p>
                                </Alert>
                                <Alert variant="info">
                                    <p className="p-3 mb-0">
                                    ...
                                    <p className="mb-0 p-3">
                                        <button className="btn btn-info mb-2">Ok</button><button className="btn btn-light mb-2 ml-2">Cancel</button>
                                    </p>
                                </Alert>
                            </div>
                        </div>
