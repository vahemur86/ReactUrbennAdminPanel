                ...
                <div className="product-nav-wrapper row">
                  ...
                  <div className="col-lg-8 col-md-7 product-filter-options">
                    ...
                    <ul className="account-user-actions">
                      <li><a href="!#" onClick={event => event.preventDefault()}><i className="ti-search"></i></a></li>
                      <li>
                        <a href="!#" onClick={event => event.preventDefault()}><i className="ti-shopping-cart"></i>
                    ...
                    <div className="card">
                      <div className="card-body">
                        <div className="action-holder">
                          ...
                          <span className="favorite-button"><i className="ti-heart"></i></span>
                        </div>
                        <div className="product-img-outer">
                          <img className="product_image" src="https://via.placeholder.com/286x218" alt="prduct" />
                        </div>
