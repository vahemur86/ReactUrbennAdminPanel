...
const initialData = {
  tasks: {
    'task-1': {
      ...
      date: '20 Feb 2019',
      img1URL:"https://via.placeholder.com/35x35",
      img2URL:"https://via.placeholder.com/35x35",
      img3URL:"https://via.placeholder.com/35x35",
      priority:'important',
      dueDate:'Due 10 days',
              ...
              <div className="d-flex flex-column flex-md-row align-items-center flex-wrap">
                  ...
                  <div className="wrapper d-none d-lg-flex  align-items-center my-2">
                    <div className="image-grouped ml-md-4">
                      <img src="https://via.placeholder.com/35x35" alt="profile" />
                      <img src="https://via.placeholder.com/35x35" alt="profile "/>
                      <img src="https://via.placeholder.com/35x35" alt="profile "/>
                    </div>
                    <button type="button" className="btn private-btn btn-fw ml-4"><i className="ti-lock"></i>Private</button>
                  </div>
