            ...
            <div className="card">
              <div className="card-body">
                ...
                <div className="icons-list row">
                  ...
                  <div className="col-sm-6 col-md-4 col-lg-3"><i className="fa fa-refresh"></i> fa-refresh</div>
            ...
            <div className="card">
              <div className="card-body">
                ...
                <div className="row icons-list">
                  ...
                  <div className="col-sm-6 col-md-4 col-lg-3"><i className="fa fa-spin fa-refresh"></i> fa-refresh</div>
